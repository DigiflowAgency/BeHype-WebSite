...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://behype.fr/influenceur/foodmarseille",
  },
  alternates: { canonical: "https://behype.fr/influenceur/foodmarseille" },
}
...
export default function Page() {
  return (
    <InfluencerPageTemplate
      ...
      stats={[
        { value: "38K+", label: "Followers Instagram" },
        { value: "6%", label: "Taux d'engagement" },
        { value: "300+", label: "Restaurants testés" },
